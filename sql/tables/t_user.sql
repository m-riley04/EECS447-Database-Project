CREATE TABLE user(  
    ...
    membership_type_id INT FOREIGN KEY REFERENCES membership_type(membership_type_id), -- Need to wait until this table is in
    account_status_id INT FOREIGN KEY REFERENCES account_status(account_status_id), -- Need to wait until this table is in
